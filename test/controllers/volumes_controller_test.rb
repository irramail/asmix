...
class VolumesControllerTest < ActionController::TestCase
  ...
  test "should create volume" do
    assert_difference('Volume.count') do
      post :create, volume: { description: @volume.description, device_id: @volume.device_id, name: @volume.name, value: @volume.value }
    end
  ...
  test "should update volume" do
    patch :update, id: @volume, volume: { description: @volume.description, device_id: @volume.device_id, name: @volume.name, value: @volume.value }
    assert_redirected_to volume_path(assigns(:volume))
  end

class TypeoftasksController < ApplicationController
  ...
  def gen
    ...
    Typeoftask.create!(name: "JINJLES", priority: "20")
    Typeoftask.create!(name: "NEWID", priority: "21")
    Typeoftask.create!(name: "SENDWAVE", priority: "22")
    Typeoftask.create!(name: "SENDPLSOFDAY", priority: "23")
    Typeoftask.create!(name: "DEL.TASK", priority: "24")
    Typeoftask.create!(name: "CHGPWD", priority: "25")
    Typeoftask.create!(name: "MUTEOFF", priority: "26")
    Typeoftask.create!(name: "FWEIGHT", priority: "27")
    Typeoftask.create!(name: "CFWEIGHT", priority: "28")
    Typeoftask.create!(name: "SLEEP", priority: "29")
    Typeoftask.create!(name: "IMAGEGET", priority: "30")
    Typeoftask.create!(name: "IMAGEVIEW", priority: "31")
    Typeoftask.create!(name: "EXTDOWNLOADS", priority: "32")
    Typeoftask.create!(name: "DEL.FILES", priority: "33")
    Typeoftask.create!(name: "SET.FILES.WEIGHT", priority: "34")
    Typeoftask.create!(name: "CHG.FILES.WEIGHT", priority: "35")
    Typeoftask.create!(name: "SEND.BGPLS", priority: "36")
    Typeoftask.create!(name: "SEND.ADPLS", priority: "37")
